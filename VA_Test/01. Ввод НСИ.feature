...
//Сценарий: Создание Владельца карты
//* Удаление элемента
//	Когда открылось окно 'Владелец карты'
//	И я нажимаю на кнопку с именем 'ФормаНайти'
//	Тогда открылось окно 'Найти'
//	И в поле с именем 'Pattern' я ввожу текст 'Иванов Сергей Иванович'
...
//И в поле с именем 'ДатаРождения' я ввожу текст '01.12.1985'
...
//И я жду закрытия окна 'Владелец карты (создание) *' в течение 20 секунд
//
//* Проверка заполнения
//	Когда открылось окно 'Владелец карты'
//	И в таблице "Список" я выбираю текущую строку
//	Тогда открылось окно 'Иванов Сергей Иванович (Владелец карты)'
//	И Я закрываю окно 'Иванов Сергей Иванович (Владелец карты)'
...
* Создание элемента
	...
	И я нажимаю на кнопку с именем 'ФормаЗаписатьИЗакрыть'
	И я жду закрытия окна 'Единицы измерения (создание) *' в течение 20 секунд
...
* Создание элемента
	...
	И я перехожу к следующему реквизиту
	И из выпадающего списка с именем "НДС" я выбираю точное значение 'Без НДС'
	И я перехожу к следующему реквизиту
...
* Создание элемента
	...
	И из выпадающего списка с именем "ВладелецКарты" я выбираю точное значение 'Иванов Сергей Иванович'
	И из выпадающего списка с именем "ВидДисконтнойКарты" я выбираю точное значение 'Сертификат'
	И в поле с именем 'КоличествоЧеков' я ввожу текст '6'
	И я перехожу к следующему реквизиту
	И я устанавливаю флаг с именем 'Бонусная'
	И в поле с именем 'Наименование' я ввожу текст 'Карта Иванова СИ'
	И я нажимаю на кнопку с именем 'ФормаЗаписать'
	Тогда открылось окно 'Карта Иванова СИ (Информационные карты)'
	И Я закрываю окно 'Карта Иванова СИ (Информационные карты)'
